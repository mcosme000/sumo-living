function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegationResponsive)}function navegationResponsive(){document.querySelector(".nav-content").classList.toggle("show")}
